...
"[project]/node_modules/franc-min/data.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/franc-min/expressions.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/franc-min/index.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ /* Load `trigram-utils`. */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$trigram$2d$utils$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/trigram-utils/index.js [client] (ecmascript)");
/* Load `expressions` (regular expressions matching
 * scripts). */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$franc$2d$min$2f$expressions$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/franc-min/expressions.js [client] (ecmascript)");
/* Load `data` (trigram information per language,
 * per script). */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$franc$2d$min$2f$data$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/franc-min/data.js [client] (ecmascript)");
;
;
;
...
for(script in __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$franc$2d$min$2f$data$2e$js__$5b$client$5d$__$28$ecmascript$29$__["data"]){
    if (own.call(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$franc$2d$min$2f$data$2e$js__$5b$client$5d$__$28$ecmascript$29$__["data"], script)) {
        const languages = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$franc$2d$min$2f$data$2e$js__$5b$client$5d$__$28$ecmascript$29$__["data"][script];
...
function francAll(value, options = {}) {
   ...
   * in `value`. */ const script = getTopScript(value, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$franc$2d$min$2f$expressions$2e$js__$5b$client$5d$__$28$ecmascript$29$__["expressions"]);
   ...
   * normalize the distance values. */ return normalize(value, getDistances((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$trigram$2d$utils$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["asTuples"])(value), numericData[script[0]], only, ignore));
}
/**
...
//# sourceMappingURL=node_modules_franc-min_0d54f7b0.async.js.map