...
"[project]/node_modules/@univerjs/engine-formula/lib/es/facade.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$observable$2f$race$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/rxjs/dist/esm5/internal/observable/race.js [client] (ecmascript)");
...
let FFormula = class FFormula extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$core$2f$lib$2f$es$2f$facade$2e$js__$5b$client$5d$__$28$ecmascript$29$__["FBase"] {
	...
	* ```
	*/ executeCalculation() {
        this._commandService.executeCommand(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SetTriggerFormulaCalculationStartMutation"].id, {
            commands: [],
	...
	* ```
	*/ stopCalculation() {
        this._commandService.executeCommand(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SetFormulaCalculationStopMutation"].id, {});
    }
    /**
	...
	*/ calculationStart(callback) {
        return this._commandService.onCommandExecuted((command)=>{
            if (command.id === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SetFormulaCalculationStartMutation"].id) {
	...
	*/ calculationEnd(callback) {
        return this._commandService.onCommandExecuted((command)=>{
            if (command.id !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SetFormulaCalculationNotificationMutation"].id) return;
            const params = command.params;
	...
	*/ whenComputingCompleteAsync(timeout) {
        const gcss = this._injector.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["GlobalComputingStatusService"]);
        if (gcss.computingStatus) return Promise.resolve(true);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$firstValueFrom$2e$js__$5b$client$5d$__$28$ecmascript$29$__["firstValueFrom"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$observable$2f$race$2e$js__$5b$client$5d$__$28$ecmascript$29$__["race"])(gcss.computingStatus$.pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$operators$2f$filter$2e$js__$5b$client$5d$__$28$ecmascript$29$__["filter"])((computing)=>computing)), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$observable$2f$timer$2e$js__$5b$client$5d$__$28$ecmascript$29$__["timer"])(timeout !== null && timeout !== void 0 ? timeout : 3e4).pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$operators$2f$map$2e$js__$5b$client$5d$__$28$ecmascript$29$__["map"])(()=>false))));
    }
    /**
	* @deprecated Use `onCalculationResultApplied` instead.
	*/ onCalculationEnd() {
	...
	*/ setMaxIteration(maxIteration) {
        this._configService.setConfig(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ENGINE_FORMULA_CYCLE_REFERENCE_COUNT"], maxIteration);
    }
    /**
	...
	*/ executeFormulas(formulas, timeout = 3e4) {
        return new Promise((resolve, reject)=>{
            const disposable = this._commandService.onCommandExecuted((command)=>{
                if (command.id !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SetFormulaStringBatchCalculationResultMutation"].id) return;
                const params = command.params;
                clearTimeout(timer);
                disposable.dispose();
            ...
            this._commandService.executeCommand(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SetFormulaStringBatchCalculationMutation"].id, {
                formulas
            }, {
                onlyLocal: true
            });
	...
	*/ getAllDependencyTrees(timeout = 3e4) {
        return new Promise((resolve, reject)=>{
            const disposable = this._commandService.onCommandExecuted((command)=>{
                if (command.id !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SetFormulaDependencyCalculationResultMutation"].id) return;
                const params = command.params;
                clearTimeout(timer);
                disposable.dispose();
                if (params.result != null) resolve(params.result);
            ...
            this._commandService.executeCommand(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SetFormulaDependencyCalculationMutation"].id, void 0, {
                onlyLocal: true
            });
        });
    }
	...
	*/ getCellDependencyTree(param, timeout = 3e4) {
        return new Promise((resolve, reject)=>{
            const disposable = this._commandService.onCommandExecuted((command)=>{
                if (command.id !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SetCellFormulaDependencyCalculationResultMutation"].id) return;
                const params = command.params;
                clearTimeout(timer);
                disposable.dispose();
            ...
            this._commandService.executeCommand(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SetCellFormulaDependencyCalculationMutation"].id, param, {
                onlyLocal: true
            });
        });
    }
	...
	*/ getRangeDependents(unitRanges, timeout = 3e4) {
        return new Promise((resolve, reject)=>{
            const disposable = this._commandService.onCommandExecuted((command)=>{
                if (command.id !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SetQueryFormulaDependencyResultMutation"].id) return;
                const params = command.params;
                clearTimeout(timer);
                disposable.dispose();
                if (params.result != null) resolve(params.result);
            ...
            this._commandService.executeCommand(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SetQueryFormulaDependencyMutation"].id, {
                unitRanges
            }, {
                onlyLocal: true
            });
	...
	*/ setFormulaReturnDependencyTree(value) {
        this._configService.setConfig(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ENGINE_FORMULA_RETURN_DEPENDENCY_TREE"], value);
    }
    /**
	...
	*/ getRangeDependentsAndInRangeFormulas(unitRanges, timeout = 3e4) {
        return new Promise((resolve, reject)=>{
            const disposable = this._commandService.onCommandExecuted((command)=>{
                if (command.id !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SetQueryFormulaDependencyAllResultMutation"].id) return;
                const params = command.params;
                clearTimeout(timer);
                disposable.dispose();
                if (params.result != null) resolve(params.result);
            ...
            this._commandService.executeCommand(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SetQueryFormulaDependencyAllMutation"].id, {
                unitRanges
            }, {
                onlyLocal: true
            });
...
FFormula = __decorate([
    ...
    __decorateParam(4, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["IFunctionService"]),
    __decorateParam(5, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["IDefinedNamesService"]),
    __decorateParam(6, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$engine$2d$formula$2f$lib$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ISuperTableService"])
], FFormula);
//#endregion
...
*/ var FUniverEngineFormulaMixin = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$core$2f$lib$2f$es$2f$facade$2e$js__$5b$client$5d$__$28$ecmascript$29$__["FUniver"] {
    getFormula() {
        return this._injector.createInstance(FFormula);
    }
};
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$univerjs$2f$core$2f$lib$2f$es$2f$facade$2e$js__$5b$client$5d$__$28$ecmascript$29$__["FUniver"].extend(FUniverEngineFormulaMixin);
;
...
//# sourceMappingURL=node_modules__univerjs_engine-formula_lib_es_facade_0ee8b7b8.async.js.map