...
"[project]/node_modules/opentype.js/dist/opentype.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
var opentype = (()=>{
    ...
    Path.prototype.fromSVG = function(pathData, options = {}) {
        ...
        function applyCommand() {
            ...
            if (relative && commandType !== "H" && commandType !== "V") {
                parsedBuffer = makeRelative.apply(this, [
                    parsedBuffer
                ]);
            }
    ...
    Path.prototype.toPathData = function(options) {
        ...
        for(let i = 0; i < commandsCopy.length; i += 1){
            ...
            if (cmd.type === "M") {
                ...
                d += "C" + packValues(cmd.x1, flipY ? flipYBase - cmd.y1 : cmd.y1, cmd.x2, flipY ? flipYBase - cmd.y2 : cmd.y2, cmd.x, flipY ? flipYBase - cmd.y : cmd.y);
            } else if (cmd.type === "Q") {
    ...
    Parser.prototype.parseTupleVariationStoreList = function(axisCount, flavor, glyphs) {
        ...
        for(let i = 0; i < glyphCount; i++){
            ...
            glyphVariations[i] = length ? this.parseTupleVariationStore(glyphVariationDataArrayOffset + currentOffset, axisCount, flavor, glyphs, i) : void 0;
    ...
    function parseCmapTable(data, start) {
        ...
        if (cmap.format === 0) {
            ...
            throw new Error("Only format 0 (platformId 1, encodingId 0), 4, 12 and 14 cmap tables are supported (found format " + cmap.format + ", platformId " + platformId + ", encodingId " + encodingId + ").");
        }
        if (format14Parser) {
    ...
    function makeCpalTable({ version = 0, numPaletteEntries = 0, colorRecords = [], colorRecordIndices = [
        0
    ] }) {
    ...
    function formatColor(bgra, format = "hexa") {
        ...
        let hsl = [
            "hsl",
            "hsla"
        ].includes(format) ? rgbToHSL(bgra) : null;
        switch(format){
            case "rgba":
    ...
    Glyph.prototype.toSVG = function(options, font) {
        const pathData = this.toPathData.apply(this, [
            options,
            font
        ]);
    ...
    function parseCFFTable(data, start, font, opt) {
        ...
        if (header.formatMajor > 1) {
            ...
            topDict = gatherCFFTopDicts(data, 0, [
                topDictData
            ], void 0, header.formatMajor)[0];
        } else {
    ...
    function parseFvarInstance(data, start, axes, names, instanceSize) {
        ...
        inst.name = getNameByID(names, subfamilyNameID, [
            2,
            17
        ]);
        p.skip("uShort", 1);
        ...
        inst.postScriptName = inst.postScriptNameID !== void 0 ? getNameByID(names, postScriptNameID, [
            6
        ]) : "";
        return inst;
    }
    ...
    exec = function(state) {
        ...
        for(state.ip = 0; state.ip < pLen; state.ip++){
            if (++state.instructionCount > MAX_INSTRUCTIONS) {
                throw new Error("Hinting instructions exceeded maximum of " + MAX_INSTRUCTIONS);
            }
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
    ...
    FeatureQuery.prototype.getLookupMethod = function(lookupTable, subtable) {
        ...
        switch(substitutionType){
            case "11":
                return (glyphIndex)=>singleSubstitutionFormat1.apply(this, [
                        glyphIndex,
                        subtable
                    ]);
            case "12":
                return (glyphIndex)=>singleSubstitutionFormat2.apply(this, [
                        glyphIndex,
                        subtable
                    ]);
            case "63":
                return (contextParams)=>chainingSubstitutionFormat3.apply(this, [
                        contextParams,
                        subtable
                    ]);
            case "41":
                return (contextParams)=>ligatureSubstitutionFormat1.apply(this, [
                        contextParams,
                        subtable
                    ]);
            case "21":
                return (glyphIndex)=>decompositionSubstitutionFormat1.apply(this, [
                        glyphIndex,
                        subtable
                    ]);
            case "51":
                return (contextParams)=>contextSubstitutionFormat1.apply(this, [
                        contextParams,
                        subtable
                    ]);
            case "53":
                return (contextParams)=>contextSubstitutionFormat3.apply(this, [
                        contextParams,
                        subtable
                    ]);
            default:
                throw new Error(`substitutionType : ${substitutionType} lookupType: ${lookupTable.lookupType} - substFormat: ${subtable.substFormat} is not yet supported`);
        }
    };
    FeatureQuery.prototype.lookupFeature = function(query) {
        ...
        if (!feature) return new Error(`font '${(this.font.names.unicode || this.font.names.windows || this.font.names.macintosh).fullName.en}' doesn't support feature '${query.tag}' for script '${query.script}'.`);
    ...
    function isVariationSequenceSelector(char) {
        ...
        return(// Mongolian Variation Selectors
...
(function(root, factory) {
    if (typeof define === 'function' && define.amd) ((r)=>r !== undefined && __turbopack_context__.v(r))(factory(__turbopack_context__.r, exports, module));
    else if (("TURBOPACK compile-time value", "object") === 'object' && /*TURBOPACK member replacement*/ __turbopack_context__.m.exports) /*TURBOPACK member replacement*/ __turbopack_context__.m.exports = factory();
    else root.opentype = factory();
})(typeof self !== 'undefined' ? self : /*TURBOPACK member replacement*/ __turbopack_context__.e, ()=>({
        ...opentype,
        'default': opentype
    }));
...
//# sourceMappingURL=node_modules_opentype_js_dist_opentype_507d2038.async.js.map